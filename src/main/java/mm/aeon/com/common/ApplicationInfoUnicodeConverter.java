...
public class ApplicationInfoUnicodeConverter implements Serializable {
	...
	public static ApplicationInfoDto convertZawgyiToUnicode(ApplicationInfoDto applicationInfoDto) {
